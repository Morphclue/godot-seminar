...
Likewise, important events may have taken place before 2020, which just took longer to get around.
Therefore, only assumptions can be made.\\

In order to make such assumptions, the Godot engine will only be compared to other game engines that have grown in popularity on itch.io.
