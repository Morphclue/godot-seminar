...
\begin{table}[h!]
    ...
    \begin{tabular}{|c c c c|}
        \hline
        Game Engine & 2018   & 2022    & Trend                             \\
        \hline\hline
        Unity       & 47.3\% & 49.75\% & \textcolor{PineGreen}{$\nearrow$} \\
        Construct   & 12.3\% & 13.12\% & \textcolor{PineGreen}{$\nearrow$} \\
        GameMaker   & 11.0\% & 7.32\%  & \textcolor{red}{$\searrow$}       \\
        Twine       & 6.2\%  & 5.35\%  & \textcolor{red}{$\searrow$}       \\
        RPG Maker   & 3.9\%  & 2.74\%  & \textcolor{red}{$\searrow$}       \\
        Bitsy       & 3.3\%  & 3.11\%  & \textcolor{red}{$\searrow$}       \\
        PICO-8      & 2.9\%  & 2.68\%  & \textcolor{red}{$\searrow$}       \\
        Unreal      & 2.8\%  & 2.92\%  & \textcolor{PineGreen}{$\nearrow$} \\
        Godot       & 2.5\%  & 5.55\%  & \textcolor{PineGreen}{$\nearrow$} \\
        Ren'Py      & 2.0\%  & 1.93\%  & \textcolor{red}{$\searrow$}       \\
        Other       & 5.9\%  & 5.55\%  & \textcolor{red}{$\searrow$}       \\
        \hline
    \end{tabular}
