...
% FIXME(remove): Game engines that have experienced an increase in their percentage of total games developed between 2018 and 2023 are highlighted in green, indicating a positive trend.
% FIXME(remove) Conversely, game engines that have seen a decrease are highlighted in red, suggesting a decline in their usage over the same period.
...
However, pinpointing the exact reasons for the Godot Engine's remarkable growth from the beginning of 2020 is challenging due to the multitude of potential factors involved.
Likewise, important events may have taken place before 2020 that just took longer to become noticeable.
Therefore, only assumptions can be made about the growth in popularity.
Furthermore, this analysis has its limitations, as it relies on the quantity of games published.
